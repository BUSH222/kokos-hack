...
INSERT INTO shop (product_name, description, picture)
VALUES
('Team Jersey', 'Official team jersey', 'https://cdn.example.com/jersey.jpg'),
('Football', 'Official match football', 'https://cdn.example.com/football.jpg'),
('Scarf', 'Team scarf', 'https://cdn.example.com/scarf.jpg'),
('Cap', 'Team cap', 'https://cdn.example.com/cap.jpg'),
('Poster', 'Team poster', 'https://cdn.example.com/poster.jpg');
